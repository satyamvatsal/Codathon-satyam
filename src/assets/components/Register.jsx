...
import { Calendar, Code, Trophy, Users, BookOpen, Star, Globe, MapPin } from 'lucide-react';

const CodathonComponent = () => {
  return (
    <div>
      {/* Hero Banner */}
      <div className="hero text-primary-content p-6" style={{
  backgroundImage: "url('https://res.cloudinary.com/dsshwxfk3/image/upload/v1744033872/bg11_njqnki.png')",
  backgroundSize: "cover",
  backgroundPosition: "center"
}}>
        <div className="hero-content text-center">
          <div>
            <img src="https://res.cloudinary.com/dsshwxfk3/image/upload/v1744033590/vision_bxtyb8.png" alt="Codathon Logo" className="h-24 mx-auto mb-4" />
            <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-teal-300 mb-4">
              CODATHON 2025
            </h2>
            <p className="text-lg text-gray-300">Unleash Your Coding Potential</p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <p>Programming Competition</p>
                ...
                <div className="text-center my-6">
                    <a href='https://register.visioncse.tech/'>
          <button className="btn bg-green-600 hover:bg-green-700 text-white border-green-700 btn-lg rounded-xl text-sm">REGISTER NOW</button>
          </a>
          <p className="mt-4 text-sm text-gray-400">Registration closes April 13, 2025</p>
        </div>
        {/* About the event */}
        <div className="mb-8">
          <div className="collapse collapse-plus bg-gray-800 border border-gray-700 rounded-box">
            ...
            <div className="collapse-content text-gray-300"> 
              <p className="mb-4">
              Join Vision CSE's premier programming contest, Codathon, where solo participants compete to solve real-world problems through innovative coding solutions. This challenging competition tests your coding skills, problem-solving abilities, and logical thinking within a set time frame.
              </p>
              <p>
              Whether you're a beginner or an experienced coder, Codathon is your chance to prove your skills, learn from the best, and compete for exciting prizes!
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="md:w-1/2">
                  ...
                  <div className="flex space-y-2 gap-1 flex-wrap">
                    <div className="badge badge-primary bg-green-900 text-green-200 border-green-700">Hackathons</div>
                    <div className="badge badge-primary bg-green-900 text-green-200 border-green-700">Tech Talks</div>
                    <div className="badge badge-primary bg-green-900 text-green-200 border-green-700">Workshops</div>
                    <div className="badge badge-primary bg-green-900 text-green-200 border-green-700">Mentorship</div>
                    <div className="badge badge-primary bg-green-900 text-green-200 border-green-700">Project Showcases</div>
                  </div>
                  
                  <p className="mt-4">
                    Vision CSE has grown into one of the most active and respected technical societies on campus, with successful alumni working at leading tech companies worldwide.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-black p-4 text-center text-xs text-gray-500">
        <p>Organized by Vision CSE • Department of Computer Science & Engineering</p>
